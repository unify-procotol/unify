...
import { EnhancedURPCToolBuilder } from "./urpc-tool";
...
// Using the Enhanced URPCToolBuilder for cleaner code
const toolBuilder = new EnhancedURPCToolBuilder(WeatherPlugin);
