---
title: Contributing
description: Contributing to Unify - guidelines for contributing to the framework and its packages
---

## Getting Started

Thank you for your interest in contributing to Unify! This guide will help you get started with contributing to the project.

### Development Setup

1. **Fork and clone the repository:**
   ```bash
   git clone https://github.com/your-username/unify.git
   cd unify
   ```
...
Unify is organized as a monorepo with the following packages:

- **`packages/core`** - Core types and interfaces
- **`packages/server`** - Server-side components and Unify class
- **`packages/client`** - Client-side components and UnifyClient class
- **`packages/uniweb3`** - Web3 adapters for Solana and EVM chains
...
1. **Create a new adapter class:**
   ...
   class YourAdapter implements DataSourceAdapter<YourEntity> {
