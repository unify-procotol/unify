---
title: API Reference
description: Complete API reference for Unify packages including @unilab/core, @unilab/server, and @unilab/client.
---
...
**Example:**
```typescript
import { UnifyClient } from "@unilab/client";
...
**Example:**
```typescript
import { repo } from "@unilab/client";
import { WalletEntity } from "@unilab/uniweb3/entities";
...
```typescript
import { UnifyClient, repo } from "@unilab/client";
import { WalletEntity } from "@unilab/uniweb3/entities";
