...
- 🔗 **Flexible Relations**: Support for one-to-one and one-to-many relationships
- 🚀 **Lazy Loading**: Relations are only loaded when requested
- 🎯 **Type Safe**: Full TypeScript support with proper type inference
- 📊 **Efficient Queries**: Optimized relation loading with minimal database calls
- 🔧 **Easy Setup**: Simple decorator-based configuration
