...
<Tab value="Preview">
<UniRenderCustomLayout type="basic" />
</Tab>
<Tab value="Code">
```tsx
...
<Tabs items={['Preview', 'Code']}>
<Tab value="Preview">
<UniRenderCustomLayout type="magazine" />
</Tab>
<Tab value="Code">
```tsx
import { UniRender } from '@unilab/ukit';
...
<Tabs items={['Preview', 'Code']}>
<Tab value="Preview">
<UniRenderCustomLayout type="social" />
</Tab>
<Tab value="Code">
```tsx
import { UniRender } from '@unilab/ukit';
...
<Tabs items={['Preview', 'Code']}>
<Tab value="Preview">
<UniRenderCustomLayout type="blog" />
</Tab>
<Tab value="Code">
```tsx
import { UniRender } from '@unilab/ukit';
...
<Tabs items={['Preview', 'Code']}>
<Tab value="Preview">
<UniRenderCustomLayout type="minimal" />
</Tab>
<Tab value="Code">
```tsx
import { UniRender } from '@unilab/ukit';
