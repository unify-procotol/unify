---
title: IndexedDB
description: IndexedDB adapter for uni-store
---

# IndexedDB Adapter

The IndexedDB adapter provides persistent storage for your entities in web browsers using the IndexedDB API.
