---
title: Memory
description: Memory adapter for uni-store
---

# Memory Adapter

The Memory adapter provides in-memory data storage with LRU (Least Recently Used) cache management.

## Features

- **In-memory storage** - Fast data access with no persistence
- **LRU cache** - Automatic cache size management (default: 5 items)
