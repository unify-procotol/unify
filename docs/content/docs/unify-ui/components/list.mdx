...
```css
.unify-ui-render .list-layout {
  gap: 1rem;
}

.unify-ui-render .list-layout .list-item {
  padding: 1rem;
  border-radius: 8px;
...
```css
.unify-ui-render .list-layout .list-item:hover {
...
```css
.unify-ui-render .list-layout .list-item.unread {
  background-color: #fef3c7;
  border-left: 4px solid #f59e0b;
}

.unify-ui-render .list-layout .list-item.read {
  opacity: 0.7;
}
```
...
```tsx
import { VirtualizedList } from '@unilab/unify-ui';
...
- [Table Layout](/docs/unify-ui/components/table-layout) - For structured data comparison
- [Card Layout](/docs/unify-ui/components/card-layout) - For rich visual content
- [Form Layout](/docs/unify-ui/components/form) - For detailed single-item editing
