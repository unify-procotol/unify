...
```package-install
@unilab/urpc-next @unilab/urpc-client @unilab/urpc-core @unilab/uniweb3 next react react-dom
```
...
```bash
npm install @unilab/urpc-next @unilab/urpc-client @unilab/urpc-core @unilab/uniweb3
```
