---
title: API Reference
description: Complete API reference for URPC packages including @unilab/urpc-core, @unilab/urpc-hono, @unilab/urpc-client, @unilab/urpc-next, @unilab/urpc, and @unilab/uniweb3.
---
...
```typescript
import { URPC, repo } from "@unilab/urpc-client";
import { WalletEntity } from "@unilab/uniweb3/entities";
